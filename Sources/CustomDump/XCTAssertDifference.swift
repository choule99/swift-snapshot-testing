...
@available(*, deprecated, renamed: "expectDifference") public func XCTAssertDifference<T: Equatable>(
    ...
    do {
        ...
        guard let difference = diff(expression1, expression2, format: format) else {
            XCTFail(
                """
...
@available(*, deprecated, renamed: "expectDifference") public func XCTAssertDifference<T: Sendable & Equatable>(

...
@available(tvOS, unavailable) extension SFSpeechRecognizerAuthorizationStatus: CustomDumpStringConvertible {
...
@available(iOS 10, macOS 10.15, *)
@available(tvOS, unavailable) extension SFSpeechRecognitionTaskHint: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .confirmation:
...
@available(iOS 10, macOS 10.15, *)
@available(tvOS, unavailable) extension SFSpeechRecognitionTaskState: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .canceling:

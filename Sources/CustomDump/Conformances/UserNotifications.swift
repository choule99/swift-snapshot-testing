...
@available(iOS 10, macOS 10.14, tvOS 10, watchOS 3, *) extension UNAuthorizationOptions: CustomDumpReflectable {
    public var customDumpMirror: Mirror {
        struct Option: CustomDumpStringConvertible {
            var rawValue: UNAuthorizationOptions

            var customDumpDescription: String {
                // Conditional cases make SwiftFormat and SwiftLint disagree about indentation.
...
@available(iOS 10, macOS 10.14, tvOS 10, watchOS 3, *) extension UNAuthorizationStatus: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .authorized:
...
@available(iOS 10, macOS 10.14, tvOS 10, watchOS 3, *) extension UNNotificationPresentationOptions: CustomDumpReflectable {
    public var customDumpMirror: Mirror {
        struct Option: CustomDumpStringConvertible {
...
@available(iOS 10, macOS 10.14, tvOS 10, watchOS 3, *) extension UNNotificationSetting: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .disabled:
...
@available(tvOS, unavailable)
@available(watchOS, unavailable) extension UNShowPreviewsSetting: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .always:

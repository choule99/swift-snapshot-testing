    ...
    @available(iOS 14, macCatalyst 14, macOS 11, tvOS 14, *) extension PHAccessLevel: CustomDumpStringConvertible {
    ...
    @available(iOS 8, macCatalyst 13, macOS 10.13, tvOS 10, *) extension PHAuthorizationStatus: CustomDumpStringConvertible {
        public var customDumpDescription: String {
            switch self {
                case .authorized:

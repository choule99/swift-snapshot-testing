...
@available(iOS 11, watchOS 4, *) extension CMAuthorizationStatus: CustomDumpStringConvertible {
...
@available(watchOS 7.2, *) extension CMFallDetectionEvent.UserResolution: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .confirmed:
...
@available(iOS 10, watchOS 3, *) extension CMPedometerEventType: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .pause:

...
@available(watchOS, unavailable) extension UNNotificationContentExtensionMediaPlayPauseButtonType: CustomDumpStringConvertible {
...
@available(iOS 10, macCatalyst 14, macOS 11, *)
@available(tvOS, unavailable)
@available(watchOS, unavailable) extension UNNotificationContentExtensionResponseOption: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .dismiss:

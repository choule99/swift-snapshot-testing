...
@available(watchOS, unavailable) extension UIScrollView.ContentInsetAdjustmentBehavior: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .always:
...
@available(watchOS, unavailable) extension UIUserInterfaceStyle: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .dark:
...
@available(watchOS, unavailable) extension UIControl.State: CustomDumpReflectable {
        ...
        struct Option: CustomDumpStringConvertible {
            ...
            var customDumpDescription: String {
                switch self.rawValue {
                    ...
                    default:
                        "UIControl.State(rawValue: \(self.rawValue))"
                }
            }
        }
...
@available(watchOS, unavailable) extension UISplitViewController.DisplayMode: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .automatic:
...
@available(watchOS, unavailable) extension UISplitViewController.DisplayModeButtonVisibility: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .automatic:
...
@available(watchOS, unavailable) extension UISplitViewController.SplitBehavior: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .automatic:
...
@available(iOS 14.0, macCatalyst 14.0, tvOS 14.0, *)
@available(watchOS, unavailable) extension UISplitViewController.Column: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .primary:
...
@available(iOS 14.0, macCatalyst 14.0, tvOS 14.0, *)
@available(watchOS, unavailable) extension UISplitViewController.Style: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .unspecified:
...
@available(watchOS, unavailable) extension UISplitViewController.PrimaryEdge: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .leading:
...
@available(watchOS, unavailable) extension UISplitViewController.BackgroundStyle: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .none:

    ...
    @available(iOS 3, macCatalyst 13, macOS 10.7, tvOS 9, watchOS 6.2, *) extension SKPaymentTransactionState: CustomDumpStringConvertible {
    ...
    @available(iOS 11.2, macCatalyst 13, macOS 10.13.2, tvOS 11.2, watchOS 6.2, *) extension SKProduct.PeriodUnit: CustomDumpStringConvertible {
        public var customDumpDescription: String {
            switch self {
                case .day:

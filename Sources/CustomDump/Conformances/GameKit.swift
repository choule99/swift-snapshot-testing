...
#if !os(watchOS)
#if compiler(>=5.5)
@available(iOS 14, macOS 11, macCatalyst 14, tvOS 14, *) extension GKAccessPoint.Location: CustomDumpStringConvertible {
...
@available(iOS 5, macCatalyst 13, macOS 10.8, tvOS 9, *) extension GKPlayer.PhotoSize: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .normal:
...
@available(watchOS, unavailable) extension GKTurnBasedMatch.Outcome: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .customRange:
...
@available(iOS 5, macCatalyst 13, macOS 10.8, tvOS 9, watchOS 3, *)
@available(watchOS, unavailable) extension GKTurnBasedMatch.Status: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .ended:
...
@available(iOS 5, macCatalyst 13, macOS 10.8, tvOS 9, watchOS 3, *)
@available(watchOS, unavailable) extension GKTurnBasedParticipant.Status: CustomDumpStringConvertible {
    public var customDumpDescription: String {
        switch self {
            case .active:

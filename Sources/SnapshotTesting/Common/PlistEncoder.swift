...
extension DecodingError {
    static func _typeMismatch(at path: [CodingKey], expectation: Any.Type, reality: Any)
        -> DecodingError {
...
private struct _PlistUnkeyedEncodingContainer: UnkeyedEncodingContainer {
    ...
    mutating func encodeNil() throws {
        self.container.add(_plistNullNSString)
    }
...
private extension _PlistEncoder {
    ...
    func box(_ value: some Encodable) throws -> NSObject {
...
open class PropertyListDecoder {
    ...
    /// - throws: `DecodingError.dataCorrupted` if values requested from the payload are corrupted, or if the given data is not a valid property list.
    /// - throws: An error if any value throws an error during decoding.
    func decode<T: Decodable>(_ type: T.Type, fromTopLevel container: Any) throws -> T {
...
private extension _PlistDecoder {
    ...
    func unbox(_ value: Any, as type: Bool.Type) throws -> Bool? {
        if let string = value as? String, string == _plistNull {
            return nil
        }

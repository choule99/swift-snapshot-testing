...
@available(macOS 10.15, iOS 13, tvOS 13, watchOS 6, *) final class DiffTests: XCTestCase {
    func testAny() {
        XCTAssertEqual(
            diff(
                (1, 2) as Any,
    ...
    func testDictionaryCollapsing() {
        let largeDictionary = Dictionary(uniqueKeysWithValues: Array(1 ... 1000).map { ($0, "\($0)") })
